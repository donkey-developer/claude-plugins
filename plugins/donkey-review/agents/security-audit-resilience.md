...
description: Security Audit and Resilience pillar review — audit logging, tamper detection, and recovery patterns. Spawned by /donkey-review:security or /donkey-review:all.
model: haiku
