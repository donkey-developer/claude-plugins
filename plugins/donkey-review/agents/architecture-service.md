...
description: Architecture Service level review — API design, service boundaries, and integration patterns. Spawned by /donkey-review:architecture or /donkey-review:all.
model: sonnet
